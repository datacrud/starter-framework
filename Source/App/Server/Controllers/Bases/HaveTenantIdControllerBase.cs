...
{
    [Authorize]
    public abstract class HaveTenantIdControllerBase<TEntity, TVm, TRm> : ApiController, ICompanyControllerBase<TEntity>
        where TEntity : HaveTenantIdEntityBase
        where TVm : HaveTenantIdViewModelBase<TEntity>
        where TRm : HaveTenantIdRequestModelBase<TEntity>
    {
        protected IHaveTenantIdServiceBase<TEntity, TVm> Service;

        protected HaveTenantIdControllerBase(IHaveTenantIdServiceBase<TEntity, TVm> service)
        {
            Service = service;
        }
